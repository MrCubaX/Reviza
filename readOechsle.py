...
ROOT_URL = 'https://www.oechsle.pe/'
TAXONOMY_FALABELLA_URL = 'https://www.oechsle.pe/tecnologia/'
#__NEXT_DATA__ = 'return document.getElementsByTagName("script")[18].innerHTML'
tipo = '\'application/ld+json\''
#__NEXT_DATA__ = 'return document.querySelectorAll("script").item(41).innerHTML'
__NEXT_DATA__ = 'for(i=0;i<document.querySelectorAll("script").length ;++i){if(document.querySelectorAll("script")[i].text.includes("vtex.events") ==true){ return document.querySelectorAll("script")[i].text;}}'
...
def getLinksOfMenu():
    ...
    for paginaActual in range(0,NumberOfPages):
        ...
        elemento = webBrowser.find_elements_by_xpath("//*[contains(text(), 'vtex.events.addData')]")
